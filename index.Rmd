...
library(caret)
inTrain <- createDataPartition(y=activity$classe, p=0.1, list=FALSE)
...
We can see sample error to be and estimate the error appropriately from confusionMatrix, we see that sensitivity and specificity is quite high, the result is good enough, and we also predict the classe of 20 pml.tesing, they are  `predictions`.
